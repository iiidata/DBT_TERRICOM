  ...
  create  table "test".test_vbd."post_insights__dbt_tmp"
  as (
    
with __dbt__CTE__post_insights_ab1 as (
...
select
    ...
    _airbyte_emitted_at
from "test".test_vbd._airbyte_raw_post_insights as table_alias
-- post_insights
),  __dbt__CTE__post_insights_ab2 as (
...
select
    ...
    _airbyte_emitted_at
from __dbt__CTE__post_insights_ab1
-- post_insights
),  __dbt__CTE__post_insights_ab3 as (
...
select
 ...
 as 
    ...
    tmp.*
from __dbt__CTE__post_insights_ab2 tmp
-- post_insights
...
from __dbt__CTE__post_insights_ab3
-- post_insights from "test".test_vbd._airbyte_raw_post_insights
  );